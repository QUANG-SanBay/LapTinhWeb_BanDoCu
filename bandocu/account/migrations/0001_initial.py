    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gioi_tinh', models.CharField(blank=True, choices=[('M', 'Nam'), ('F', 'Nữ'), ('O', 'Khác')], max_length=1, null=True)),
                ...
                ('user_type', models.CharField(choices=[('buyer', 'Người mua'), ('seller', 'Người bán'), ('admin', 'Quản trị viên')], default='buyer', max_length=10)),
